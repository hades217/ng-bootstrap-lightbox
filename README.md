...
This repo is forked from https://github.com/compact/angular-bootstrap-lightbox But I have made a lot of changes and rename the name for the sake of confusing with original one. And thanks for compact creates this repo
...
2. Include the stylesheet in your app:
  ...
  ```html
  <link rel="stylesheet" href="ng-bootstrap-lightbox/dist/ng-bootstrap-lightbox.css">
  ```

3. Include the script in your app:

  ```html
  <script src="ng-bootstrap-lightbox/dist/ng-bootstrap-lightbox.js"></script>
  ```
...
* Serve the GitHub Pages:
  ...
  git checkout master -- dist/ng-bootstrap-lightbox.min.js dist/ng-bootstrap-lightbox.min.css
  bundle install
  bundle exec jekyll serve
  ```
# TODO

* Add description section when viewing the image
* Add translating animation when switch different images
* More animation options
* Full screen when using mobile screen, just for ionic
* api for image src of next and pre button
